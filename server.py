...
.toast-box {
  ...
  padding: 28px 36px; border-radius: 22px; min-width: 180px;
...
.toast-label {
  font-family: 'Orbitron', sans-serif; font-size: 0.82rem; font-weight: 900;
...
#vk-name-badge { display:inline-block; }
...
<div class="tab active" id="tab-trangchu">
  ...
  <div class="music-player-card">
    ...
    <div style="margin-bottom:8px;text-align:center;">
      <div id="vk-name-badge" style="font-family:'Orbitron',sans-serif;font-size:1.22rem;font-weight:900;background:var(--grad);-webkit-background-clip:text;-webkit-text-fill-color:transparent;letter-spacing:3px;animation:vkNamePulse 2.5s ease-in-out infinite;display:inline-block;">VĂN KHÁNH</div>
      <div style="font-size:0.66rem;color:var(--muted);font-weight:700;letter-spacing:1.5px;text-transform:uppercase;margin-top:2px;">✦ Admin Server ✦</div>
    </div>
    <div class="dj-main">
